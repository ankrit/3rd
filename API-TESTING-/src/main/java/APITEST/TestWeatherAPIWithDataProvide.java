...
import API_TESTING_.API_TESTING_.BaseClass;
import API_TESTING_.API_TESTING_.ExcelReaderPoi;

import com.relevantcodes.extentreports.LogStatus;

public class TestWeatherAPIWithDataProvide extends BaseClass{
	
	String currentDir= System.getProperty("user.dir")+File.separator+"\\Exel\\TestData (1).xlsx";
	...
	public void verifyWeatherInfoWithPositiveData(Map mObj)
	{
		...
		ValidatableResponse response = RestAssured.given().param("q", cityName)
				...
				.get().then();
		//System.out.println("cccccc"+response);
